...
public class ContatoClienteBean {
	...
	private String data_Cli_Contato;
	...
	public String getData_Cli_Contato() {
		return data_Cli_Contato;
	}
	public void setData_Cli_Contato(String data_Cli_Contato) {
		this.data_Cli_Contato = data_Cli_Contato;
	}
